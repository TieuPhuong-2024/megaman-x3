...
// Avoid importing entire std namespace here; qualify std types where used to prevent
// symbol collisions (for example with Windows headers).

class Sprite : public Transformable
{
public:
	Sprite(LPD3DXSPRITE spriteHandle, LPCWSTR filePath, int totalFrames = 1, int cols = 1);
