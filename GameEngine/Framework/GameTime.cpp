...
GameTime::GameTime(const TimeSpan& elapsedGameTime)
{
...
void GameTime::setElapsedGameTime(const TimeSpan& elapsedgametime)
{
	this->_elapsedGameTime = elapsedgametime;
}

void GameTime::setTotalGameTime(const TimeSpan& totalGametime)
{
